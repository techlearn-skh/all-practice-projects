...
public class SwaggerApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .tags(Arrays.asList(
                        new Tag().name("EmployeeRestController API").description("Operations for welcome and fullName endpoints exposed by EmployeeRestController")
                ));
    }
}
